...
const availability = [
  { date: "2026-08-13", times: STANDARD_SLOT_TIMES, capacity: 3 },
  { date: "2026-08-14", times: STANDARD_SLOT_TIMES, capacity: 5 },
  { date: "2026-08-17", times: STANDARD_SLOT_TIMES, capacity: 5 },
...
async function selectDate(iso, dateObj) {
  selectedDateISO = iso;
  timeSlotInput.value = "";
  renderCalendar();
